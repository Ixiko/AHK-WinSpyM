...
Gui Add, Tab3, hWndhTab vTab gTabHandler x10 y50 w482 h373 AltSubmit -Wrap, General|Styles|Details|Messages|Extra|Windows|Process
; General
Gui Tab, 1
...
Gui Add, Button, gWSReload x395 y432 w84 h24, &Reload
...
Gui Show, x%px% y%py% w600 h465 Hide, %AppName% ; Show main window
If (g_Minimize) {
